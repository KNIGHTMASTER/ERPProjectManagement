...
<html>
	...
	<body>
		<a href="#edit-identificationCostManagementPlan" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-identificationCostManagementPlan" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${identificationCostManagementPlanInstance?.version}" />
				<fieldset class="form">
