...
<html>
	...
	<body>
		<a href="#edit-identificationTimeManagementPlan" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-identificationTimeManagementPlan" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${identificationTimeManagementPlanInstance?.version}" />
				<fieldset class="form">
