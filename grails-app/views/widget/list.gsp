			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="project" title="${message(code: 'widget.project.label', default: 'Project')}" />
				...
				<g:each in="${widgetInstanceList}" status="i" var="widgetInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${widgetInstance.id}">${fieldValue(bean: widgetInstance, field: "project")}</g:link></td>
