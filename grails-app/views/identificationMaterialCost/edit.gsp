...
<html>
	...
	<body>
		<a href="#edit-identificationMaterialCost" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-identificationMaterialCost" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${identificationMaterialCostInstance?.version}" />
				<fieldset class="form">
