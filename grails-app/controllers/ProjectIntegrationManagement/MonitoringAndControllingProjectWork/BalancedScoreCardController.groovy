...
class BalancedScoreCardController {
    ...
    def index() {
        ...
        if(session.proyek){
            ...
            [dataBSC:createChartPie(), namaProyek:namaProyek]
        }else{
            namaProyek = ""
            redirect uri:"/chooseProject?tautan=BalancedScoreCard"
        }
    }
...
//==================START OBJECT QUERY=================
    ...
    def createChartPie(){
        def total = createBSC();
        def ini = new String[4];
        ini[0] = "'Finance',"+total[0];
        ini[1] = "'Internal Process',"+total[1];
        ini[2] = "'Learning And Growth',"+total[2];
        ini[3] = "'Customer',"+total[3];
    ...
    <script type="text/javascript" >
        ...
        chart = new Highcharts.Chart({
            chart: {
                renderTo: 'containerBSC',
                plotBackgroundColor: null,
                plotBorderWidth: null,
                plotShadow: true
            },
            title: {
                text: 'Pie Chart Balanced ScoreCard'
            },
            tooltip: {
