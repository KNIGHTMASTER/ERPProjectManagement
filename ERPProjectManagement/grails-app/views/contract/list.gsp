			...
			<table>
				<thead>
					<tr>
						...
						<th><g:message code="contract.projectName.label" default="Project Name" /></th>
				...
				<g:each in="${contractInstanceList}" status="i" var="contractInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${contractInstance.id}">${fieldValue(bean: contractInstance, field: "projectName")}</g:link></td>
					
						<td>${fieldValue(bean: contractInstance, field: "vendorName")}</td>
