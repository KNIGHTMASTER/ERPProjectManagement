...
<div class="fieldcontain ${hasErrors(bean: contractInstance, field: 'projectName', 'error')} required">
	<label for="projectName">
		<g:message code="contract.projectName.label" default="Project Name" />
		<span class="required-indicator">*</span>
	</label>
	<g:select id="projectName" name="projectName.id" from="${ProjectIntegrationManagement.DevelopProjectCharter.ProjectCharter.list()}" optionKey="id" required="" value="${contractInstance?.projectName?.id}" class="many-to-one"/>
</div>
