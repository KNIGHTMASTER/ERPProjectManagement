...
<html>
	...
	<body>
		<a href="#edit-riskCategories" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-riskCategories" class="content scaffold-edit" role="main">
			<h1><g:message code="default.edit.label" args="[entityName]" /></h1>
			<g:if test="${flash.message}">
			<div class="message" role="status">${flash.message}</div>
			</g:if>
			<g:hasErrors bean="${riskCategoriesInstance}">
			<ul class="errors" role="alert">
				<g:eachError bean="${riskCategoriesInstance}" var="error">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${riskCategoriesInstance?.version}" />
				<fieldset class="form">
