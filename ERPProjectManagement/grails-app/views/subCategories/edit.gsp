...
<html>
	...
	<body>
		<a href="#edit-subCategories" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-subCategories" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${subCategoriesInstance?.version}" />
				<fieldset class="form">
